...
<section class="layout fadein">
    ...
    <?php if( get_field( 'office_history_gallery' ) ) : ?>
    <article class="grid_six fadein">
        <div class="project_media_nav">
            <ol>
                <?php $images = get_field('office_history_gallery'); ?>
                <?php if( $images ): ?>
    ...
    <article class="project_body">
        ...
        <div class="philosophy_description columned">
    ...
    <article class="project_body philo">
        <h3>Site &amp; Context</h3>
        ...
        <div class="philosophy_image">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/philosophy/site-context.jpg">
        </div>
    </article>
    <article class="project_body philo">
        <h3>Program</h3>
        ...
        <div class="philosophy_image">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/philosophy/program.jpg">
        </div>
    </article>
    <article class="project_body philo">
        <h3>Order/ Geometry</h3>
        <div class="philosophy_description">
        ...
        <div class="philosophy_image">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/philosophy/order-geometry.jpg">
        </div>
    </article>
    <article class="project_body philo">
        <h3>Image</h3>
        ...
        <div class="philosophy_image">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/philosophy/image.jpg">
        </div>
    </article>
    <article class="project_body philo">
        <h3>Light</h3>
        ...
        <div class="philosophy_image">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/philosophy/light.jpg">
        </div>
    </article>
    <article class="project_body philo">
        ...
        <div class="philosophy_image">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/philosophy/technology.jpg">
        </div>
    </article>
</section>
